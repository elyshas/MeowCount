...
public class MainActivity extends AppCompatActivity {
    ...
    /****** SCORE COUNT FOR CAT1 ******/

    /***Adding 1 point to Cat1 score count***/
    public void addMeowForKyo(View view) {
        scoreKyo = scoreKyo + 1;
        displayForKyo(scoreKyo);
    }

    /***Adding 3 points to Cat1 score count***/
    public void addPurrForKyo(View view) {
        scoreKyo = scoreKyo + 3;
        displayForKyo(scoreKyo);
    }

    /***Subtracting 2 points from Cat1 score count***/
    ...
    /****** SCORE COUNT FOR CAT2 ******/

    /***Adding 1 point to Cat2 score count***/
    public void addMeowForAlice(View view) {
        scoreAlice = scoreAlice + 1;
        displayForAlice(scoreAlice);
    }

    /***Adding 3 points to Cat2 score count***/
    public void addPurrForAlice(View view) {
        scoreAlice = scoreAlice + 3;
        displayForAlice(scoreAlice);
    }

    /***Subtracting 2 points from Cat2 score count***/
    ...
    /***Resetting score count for CAT1 & CAT2 back to 0 points.***/
